...
*/
#define WIN_RES_ID OPTIONS_WINDOW
...
/*
	Handler for window OPTIONS_WINDOW ("Options")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
OPTIONS_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
OPTIONS_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		createOptions(xdWindow, (OPTION_TYPE) xvt_vobj_get_data(xdWindow));
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
		...
		*/
		...
		freeCopyOfOptions ((OPTION_TYPE) xvt_vobj_get_data(xdWindow));
	...
	case E_CHAR:
		...
		*/
		...
		if (xdEvent->v.chr.ch == '\r')
		{
		   ...
		   xdEvent->v.ctl.id = OPTIONS_WINDOW_PUSHBUTTON_107;
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case OPTIONS_SELECTION: /* "option list" */
			{
			/* TAG BEGIN OPTIONS_SELECTION EVNT:Control */
			selectOptionGroup (xdWindow, (OPTION_TYPE) xvt_vobj_get_data(xdWindow),
				xvt_list_get_sel_index(xvt_win_get_ctl(xdWindow, OPTIONS_SELECTION)));
			/* TAG END OPTIONS_SELECTION EVNT:Control */
			}
			break;
		case OPTIONS_WINDOW_PUSHBUTTON_107: /* "OK" */
			{
			/* TAG BEGIN OPTIONS_WINDOW_PUSHBUTTON_107 EVNT:Control */
						/* ********************************** */
						/* save all the options in the window */
			saveOptions (xdWindow, (OPTION_TYPE) xvt_vobj_get_data(xdWindow), FALSE);
			xvt_vobj_destroy(xdWindow);
			/* TAG END OPTIONS_WINDOW_PUSHBUTTON_107 EVNT:Control */
			}
			break;
		case OPTIONS_WINDOW_PUSHBUTTON_108: /* "Cancel" */
			{
			/* TAG BEGIN OPTIONS_WINDOW_PUSHBUTTON_108 EVNT:Control */
			restoreCopyOfOptions ((OPTION_TYPE) xvt_vobj_get_data(xdWindow));
			xvt_vobj_destroy(xdWindow);
			/* TAG END OPTIONS_WINDOW_PUSHBUTTON_108 EVNT:Control */
			}
			break;
		case OPTIONS_WINDOW_PUSHBUTTON_109: /* "Help..." */
			{
			/* TAG BEGIN OPTIONS_WINDOW_PUSHBUTTON_109 EVNT:Control */
			displayOptionsHelp ((OPTION_TYPE) xvt_vobj_get_data (xdWindow));
			/* TAG END OPTIONS_WINDOW_PUSHBUTTON_109 EVNT:Control */
			}
			break;
		default:
			break;

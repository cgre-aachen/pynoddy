...
/*
	Handler for window SSCL_WINDOW ("Scale (Shear Zone)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
SSCL_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
SSCL_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, SSCL_ROTATION_BAR, 0, 360);
		setScrollRange (xdWindow, SSCL_SLIP_BAR, -10000, 10000);
		setScrollRange (xdWindow, SSCL_AMPLITUDE_BAR, 0, 20000);
		setScrollRange (xdWindow, SSCL_WIDTH_BAR, 0, 20000);
		setScrollRange (xdWindow, SSCL_RADIUS_BAR, 0, 20000);
		setScrollRange (xdWindow, SSCL_CYL_BAR, 0, 20000);
		setScrollRange (xdWindow, SSCL_PP_BAR, 0, 20000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case SSCL_SLIP_BAR: /* "Horizontal Scrollbar Slip" */
			{
			/* TAG BEGIN SSCL_SLIP_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, SSCL_SLIP, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_SLIP_BAR EVNT:Control */
			}
			break;
		case SSCL_SLIP: /* "slip" */
			{
			/* TAG BEGIN SSCL_SLIP EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, SSCL_SLIP_BAR,
			                                                      SSCL_SLIP, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END SSCL_SLIP EVNT:Control */
			}
			break;
		case SSCL_ROTATION_BAR: /* "Horizontal Scrollbar Rotation" */
			{
			/* TAG BEGIN SSCL_ROTATION_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, SSCL_ROTATION, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_ROTATION_BAR EVNT:Control */
			}
			break;
		case SSCL_ROTATION: /* "30" */
			{
			/* TAG BEGIN SSCL_ROTATION EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, SSCL_ROTATION_BAR,
			                                                      SSCL_ROTATION, TRUE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END SSCL_ROTATION EVNT:Control */
			}
			break;
		case SSCL_AMPLITUDE_BAR: /* "Horizontal Scrollbar AMP" */
			{
			/* TAG BEGIN SSCL_AMPLITUDE_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, SSCL_AMPLITUDE, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_AMPLITUDE_BAR EVNT:Control */
			}
			break;
		case SSCL_AMPLITUDE: /* "2000" */
			{
			/* TAG BEGIN SSCL_AMPLITUDE EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, SSCL_AMPLITUDE_BAR,
			                                                      SSCL_AMPLITUDE, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END SSCL_AMPLITUDE EVNT:Control */
			}
			break;
		case SSCL_RADIUS_BAR: /* "Horizontal Scrollbar RADIUS" */
			{
			/* TAG BEGIN SSCL_RADIUS_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, SSCL_RADIUS, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_RADIUS_BAR EVNT:Control */
			}
			break;
		case SSCL_RADIUS: /* "radius" */
			{
			/* TAG BEGIN SSCL_RADIUS EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, SSCL_RADIUS_BAR,
			                                                      SSCL_RADIUS, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			
			}
			/* TAG END SSCL_RADIUS EVNT:Control */
			}
			break;
		case SSCL_CYL_BAR: /* "Horizontal Scrollbar CI" */
			{
			/* TAG BEGIN SSCL_CYL_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, SSCL_CYL, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_CYL_BAR EVNT:Control */
			}
			break;
		case SSCL_CYL: /* "CI" */
			{
			/* TAG BEGIN SSCL_CYL EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, SSCL_CYL_BAR,
			                                                      SSCL_CYL, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END SSCL_CYL EVNT:Control */
			}
			break;
		case SSCL_PP_BAR: /* "Horizontal Scrollbar PP" */
			{
			/* TAG BEGIN SSCL_PP_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, SSCL_PP, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_PP_BAR EVNT:Control */
			}
			break;
		case SSCL_PP: /* "PP" */
			{
			/* TAG BEGIN SSCL_PP EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, SSCL_PP_BAR,
			                                                      SSCL_PP, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END SSCL_PP EVNT:Control */
			}
			break;
		case SSCL_WIDTH_BAR: /* "Horizontal Scrollbar WIDTH" */
			{
			/* TAG BEGIN SSCL_WIDTH_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, SSCL_WIDTH, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END SSCL_WIDTH_BAR EVNT:Control */
			}
			break;
		case SSCL_WIDTH: /* "width" */
			{
			/* TAG BEGIN SSCL_WIDTH EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, SSCL_WIDTH_BAR,
			                                                      SSCL_WIDTH, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			
			}
			/* TAG END SSCL_WIDTH EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID FDSCL_WINDOW
...
/*
	Handler for window FDSCL_WINDOW ("Scale (Fold)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
FDSCL_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
FDSCL_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, FDSCL_WAVE_BAR, 0, 20000);
		setScrollRange (xdWindow, FDSCL_AMPLITUDE_BAR, 0, 20000);
		setScrollRange (xdWindow, FDSCL_CYCL_BAR, 0, 20000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case FDSCL_WAVE_BAR: /* "wave bar" */
			{
			/* TAG BEGIN FDSCL_WAVE_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, FDSCL_WAVE, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FDSCL_WAVE_BAR EVNT:Control */
			}
			break;
		case FDSCL_AMPLITUDE_BAR: /* "amp bar" */
			{
			/* TAG BEGIN FDSCL_AMPLITUDE_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FDSCL_AMPLITUDE, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FDSCL_AMPLITUDE_BAR EVNT:Control */
			}
			break;
		case FDSCL_CYCL_BAR: /* "cycle bar" */
			{
			/* TAG BEGIN FDSCL_CYCL_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FDSCL_CYCL, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FDSCL_CYCL_BAR EVNT:Control */
			}
			break;
		case FDSCL_WAVE: /* "wave" */
			{
			/* TAG BEGIN FDSCL_WAVE EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, FDSCL_WAVE_BAR, FDSCL_WAVE, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FDSCL_WAVE EVNT:Control */
			}
			break;
		case FDSCL_CYCL: /* "cycl" */
			{
			/* TAG BEGIN FDSCL_CYCL EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FDSCL_CYCL_BAR, FDSCL_CYCL, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FDSCL_CYCL EVNT:Control */
			}
			break;
		case FDSCL_AMPLITUDE: /* "amp" */
			{
			/* TAG BEGIN FDSCL_AMPLITUDE EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FDSCL_AMPLITUDE_BAR, FDSCL_AMPLITUDE, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FDSCL_AMPLITUDE EVNT:Control */
			}
			break;
		default:
			break;

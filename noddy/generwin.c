...
*/
#define WIN_RES_ID GENERIC_WINDOW
...
/*
	Handler for window GENERIC_WINDOW ("Generic")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
GENERIC_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
GENERIC_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		case GENERIC_1: /* "p1" */
			{
			/* TAG BEGIN GENERIC_1 EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END GENERIC_1 EVNT:Control */
			}
			break;
		case GENERIC_2: /* "p2" */
			{
			/* TAG BEGIN GENERIC_2 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_2 EVNT:Control */
			}
			break;
		case GENERIC_3: /* "p3" */
			{
			/* TAG BEGIN GENERIC_3 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_3 EVNT:Control */
			}
			break;
		case GENERIC_4: /* "p4" */
			{
			/* TAG BEGIN GENERIC_4 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_4 EVNT:Control */
			}
			break;
		case GENERIC_5: /* "p5" */
			{
			/* TAG BEGIN GENERIC_5 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_5 EVNT:Control */
			}
			break;
		case GENERIC_6: /* "p6" */
			{
			/* TAG BEGIN GENERIC_6 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_6 EVNT:Control */
			}
			break;
		case GENERIC_7: /* "p7" */
			{
			/* TAG BEGIN GENERIC_7 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_7 EVNT:Control */
			}
			break;
		case GENERIC_8: /* "p8" */
			{
			/* TAG BEGIN GENERIC_8 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_8 EVNT:Control */
			}
			break;
		case GENERIC_9: /* "p9" */
			{
			/* TAG BEGIN GENERIC_9 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_9 EVNT:Control */
			}
			break;
		case GENERIC_10: /* "p10" */
			{
			/* TAG BEGIN GENERIC_10 EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END GENERIC_10 EVNT:Control */
			}
			break;
		default:
			break;

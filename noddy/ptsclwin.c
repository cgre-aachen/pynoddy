...
*/
#define WIN_RES_ID PRINT_SCALE_WINDOW
...
/*
	Handler for window PRINT_SCALE_WINDOW ("print scale")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
PRINT_SCALE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
PRINT_SCALE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case PRINT_SCALE: /* "print scale" */
			{
			/* TAG BEGIN PRINT_SCALE EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END PRINT_SCALE EVNT:Control */
			}
			break;
		default:
			break;

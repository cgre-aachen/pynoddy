...
*/
#define WIN_RES_ID HELP_OPTION_WINDOW
...
/*
	Handler for window HELP_OPTION_WINDOW ("Help Options")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
HELP_OPTION_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
HELP_OPTION_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case HELP_VIEWER: /* "Edit Control 3" */
			{
			/* TAG BEGIN HELP_VIEWER EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END HELP_VIEWER EVNT:Control */
			}
			break;
		default:
			break;

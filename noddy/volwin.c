...
*/
#define WIN_RES_ID VOLUME_WINDOW
...
/*
	Handler for window VOLUME_WINDOW ("Volume")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
VOLUME_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
VOLUME_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case VOLUME_EDIT: /* "Edit Volume Options..." */
			{
			/* TAG BEGIN VOLUME_EDIT EVNT:Control */

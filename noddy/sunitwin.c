...
*/
#define WIN_RES_ID SUS_UNITS_WINDOW
...
/*
	Handler for window SUS_UNITS_WINDOW ("Sus Units")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
SUS_UNITS_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
SUS_UNITS_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case SUS_UNITS_SI: /* "s.i." */
			{
			/* TAG BEGIN SUS_UNITS_SI EVNT:Control */
			xdCheckRadioButton(xdWindow,
				SUS_UNITS_SI,
				SUS_UNITS_SI,
				SUS_UNITS_CGS);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END SUS_UNITS_SI EVNT:Control */
			}
			break;
		case SUS_UNITS_CGS: /* "c.g.s." */
			{
			/* TAG BEGIN SUS_UNITS_CGS EVNT:Control */
			xdCheckRadioButton(xdWindow,
				SUS_UNITS_CGS,
				SUS_UNITS_SI,
				SUS_UNITS_CGS);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END SUS_UNITS_CGS EVNT:Control */
			}
			break;
		default:
			break;

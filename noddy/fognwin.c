...
*/
#define WIN_RES_ID FALSE_ORIGIN_WINDOW
...
/*
	Handler for window FALSE_ORIGIN_WINDOW ("False Origin")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
FALSE_ORIGIN_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
FALSE_ORIGIN_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case FALSE_ORIGIN_EASTING: /* "east" */
			{
			/* TAG BEGIN FALSE_ORIGIN_EASTING EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END FALSE_ORIGIN_EASTING EVNT:Control */
			}
			break;
		case FALSE_ORIGIN_NORTHING: /* "north" */
			{
			/* TAG BEGIN FALSE_ORIGIN_NORTHING EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END FALSE_ORIGIN_NORTHING EVNT:Control */
			}
			break;
		default:
			break;

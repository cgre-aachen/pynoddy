...
*/
#define WIN_RES_ID TOPO_OPTIONS_WINDOW
...
/*
	Handler for window TOPO_OPTIONS_WINDOW ("Topography Options")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
TOPO_OPTIONS_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
TOPO_OPTIONS_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		loadGeologyTopoOptions (xdWindow);
	...
	case E_CHAR:
		...
		*/
		...
		if (xdEvent->v.chr.ch == '\r')
		{
		   ...
		   xdEvent->v.ctl.id = TOPO_OPTIONS_OK;
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case TOPO_OPTIONS_SCALE: /* "EdScale" */
			{
			/* TAG BEGIN TOPO_OPTIONS_SCALE EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
				setGeologyTopoRange (xdWindow);
			}
			/* TAG END TOPO_OPTIONS_SCALE EVNT:Control */
			}
			break;
		case TOPO_OPTIONS_OFFSET: /* "EdOffset" */
			{
			/* TAG BEGIN TOPO_OPTIONS_OFFSET EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END TOPO_OPTIONS_OFFSET EVNT:Control */
			}
			break;
		case TOPO_OPTIONS_CONTOUR: /* "Ed Contour" */
			{
			/* TAG BEGIN TOPO_OPTIONS_CONTOUR EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END TOPO_OPTIONS_CONTOUR EVNT:Control */
			}
			break;
		case TOPO_OPTIONS_INTERVAL: /* "Ed Interval" */
			{
			/* TAG BEGIN TOPO_OPTIONS_INTERVAL EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END TOPO_OPTIONS_INTERVAL EVNT:Control */
			}
			break;
		case TOPO_OPTIONS_OK: /* "OK" */
			{
			...
			saveGeologyTopoOptions (xdWindow);
			xvt_vobj_destroy(xdWindow);
			/* TAG END TOPO_OPTIONS_OK EVNT:Control */
			}
			break;
		case TOPO_OPTIONS_CANCEL: /* "Cancel" */
			{
			...
			xvt_vobj_destroy(xdWindow);
			/* TAG END TOPO_OPTIONS_CANCEL EVNT:Control */
			}
			break;
		case TOPO_OPTIONS_HELP: /* "Help..." */
			{
			/* TAG BEGIN TOPO_OPTIONS_HELP EVNT:Control */
			displayHelp("topomap.htm");
			/* TAG END TOPO_OPTIONS_HELP EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID GEOPHYSICS_SCALE_WINDOW
...
/*
	Handler for window GEOPHYSICS_SCALE_WINDOW ("Geoph Image scale")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
GEOPHYSICS_SCALE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
GEOPHYSICS_SCALE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case GEOPHYSICS_SCALE: /* "imagescale" */
			{
			/* TAG BEGIN GEOPHYSICS_SCALE EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END GEOPHYSICS_SCALE EVNT:Control */
			}
			break;
		default:
			break;

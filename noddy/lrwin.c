...
*/
#define WIN_RES_ID LOCAL_REMOTE_WINDOW
...
/*
	Handler for window LOCAL_REMOTE_WINDOW ("local remote job")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
LOCAL_REMOTE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
LOCAL_REMOTE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case LOCAL_REMOTE_REMOTE: /* "Remote" */
			{
			/* TAG BEGIN LOCAL_REMOTE_REMOTE EVNT:Control */
			WINDOW win;
			...
			break;
		case LOCAL_REMOTE_LOCAL: /* "Local" */
			{
			/* TAG BEGIN LOCAL_REMOTE_LOCAL EVNT:Control */
			xdCheckRadioButton(xdWindow, LOCAL_REMOTE_LOCAL,
				LOCAL_REMOTE_REMOTE, LOCAL_REMOTE_LOCAL);
			/* TAG END LOCAL_REMOTE_LOCAL EVNT:Control */
			}
			break;
		default:
			break;

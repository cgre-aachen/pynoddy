...
*/
#define WIN_RES_ID DIMENSION_WINDOW
...
/*
	Handler for window DIMENSION_WINDOW ("View Dimension")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
DIMENSION_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
DIMENSION_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, DIMENSION_X_BAR, 1, 20000);
		setScrollRange (xdWindow, DIMENSION_Y_BAR, 1, 20000);
		setScrollRange (xdWindow, DIMENSION_Z_BAR, 1, 20000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case DIMENSION_X_BAR: /* "Horizontal Scrollbar dX" */
			{
			/* TAG BEGIN DIMENSION_X_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, DIMENSION_X, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END DIMENSION_X_BAR EVNT:Control */
			}
			break;
		case DIMENSION_Y_BAR: /* "Horizontal Scrollbar dY" */
			{
			/* TAG BEGIN DIMENSION_Y_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, DIMENSION_Y, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END DIMENSION_Y_BAR EVNT:Control */
			}
			break;
		case DIMENSION_Z_BAR: /* "Horizontal Scrollbar dZ" */
			{
			/* TAG BEGIN DIMENSION_Z_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, DIMENSION_Z, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END DIMENSION_Z_BAR EVNT:Control */
			}
			break;
		case DIMENSION_X: /* "dx" */
			{
			/* TAG BEGIN DIMENSION_X EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, DIMENSION_X_BAR, DIMENSION_X, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END DIMENSION_X EVNT:Control */
			}
			break;
		case DIMENSION_Z: /* "dz" */
			{
			/* TAG BEGIN DIMENSION_Z EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, DIMENSION_Z_BAR, DIMENSION_Z, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END DIMENSION_Z EVNT:Control */
			}
			break;
		case DIMENSION_Y: /* "dy" */
			{
			/* TAG BEGIN DIMENSION_Y EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, DIMENSION_Y_BAR, DIMENSION_Y, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END DIMENSION_Y EVNT:Control */
			}
			break;
		default:
			break;

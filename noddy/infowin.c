...
*/
#define WIN_RES_ID CONTACT_WINDOW
...
/*
	Handler for window CONTACT_WINDOW ("Contact Information")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
CONTACT_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
CONTACT_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CHAR:
		...
		*/
		...
		if (xdEvent->v.chr.ch == '\r')
		{
		   ...
		   xdEvent->v.ctl.id = CONTACT_WINDOW_PUSHBUTTON_56;
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case CONTACT_WINDOW_PUSHBUTTON_56: /* "OK" */
			{
			/* TAG BEGIN CONTACT_WINDOW_PUSHBUTTON_56 EVNT:Control */
			xvt_vobj_destroy (xdWindow);
			/* TAG END CONTACT_WINDOW_PUSHBUTTON_56 EVNT:Control */
			}
			break;
		case CONTACT_WINDOW_PUSHBUTTON_57: /* "Cancel" */
			{
			/* TAG BEGIN CONTACT_WINDOW_PUSHBUTTON_57 EVNT:Control */
			xvt_vobj_destroy(xdWindow);
			/* TAG END CONTACT_WINDOW_PUSHBUTTON_57 EVNT:Control */
			}
			break;
		case CONTACT_WINDOW_PUSHBUTTON_58: /* "Help..." */
			{
			/* TAG BEGIN CONTACT_WINDOW_PUSHBUTTON_58 EVNT:Control */
			displayHelp("toc.htm");
			/* TAG END CONTACT_WINDOW_PUSHBUTTON_58 EVNT:Control */
			}
			break;
		case CONTACT_WINDOW_PUSHBUTTON_64: /* "Licence Info" */
			{
			/* TAG BEGIN CONTACT_WINDOW_PUSHBUTTON_64 EVNT:Control */
			if (createLicenceInfoFile ())
			   xvt_dm_post_error ("File 'noddylic.txt' created with Licence information.");
			else
			   xvt_dm_post_error ("Error, Could not create Licence information file.");
			/* TAG END CONTACT_WINDOW_PUSHBUTTON_64 EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID ALTITUDE_WINDOW
...
/*
	Handler for window ALTITUDE_WINDOW ("Altitude")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
ALTITUDE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
ALTITUDE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case ALTITUDE_SURFACE: /* "Surface" */
			{
			/* TAG BEGIN ALTITUDE_SURFACE EVNT:Control */
			xdCheckRadioButton(xdWindow, ALTITUDE_SURFACE, ALTITUDE_SURFACE, ALTITUDE_AIRBORNE);
			updateOptions (xdWindow, GEOPHYSICS_SURVEY_OP);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END ALTITUDE_SURFACE EVNT:Control */
			}
			break;
		case ALTITUDE_AIRBORNE: /* "Airborne" */
			{
			/* TAG BEGIN ALTITUDE_AIRBORNE EVNT:Control */
			xdCheckRadioButton(xdWindow, ALTITUDE_AIRBORNE, ALTITUDE_SURFACE, ALTITUDE_AIRBORNE);
			updateOptions (xdWindow, GEOPHYSICS_SURVEY_OP);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END ALTITUDE_AIRBORNE EVNT:Control */
			}
			break;
		case ALTITUDE_HEIGHT: /* "altitude" */
			{
			/* TAG BEGIN ALTITUDE_HEIGHT EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END ALTITUDE_HEIGHT EVNT:Control */
			}
			break;
		default:
			break;

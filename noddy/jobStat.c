...
*/
#define WIN_RES_ID JOB_STATUS_WINDOW
...
/*
	Handler for window JOB_STATUS_WINDOW ("Job Status")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
JOB_STATUS_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
JOB_STATUS_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case JOB_STATUS_CANCEL: /* "Cancel" */
			{
			/* TAG BEGIN JOB_STATUS_CANCEL EVNT:Control */
			setAbortLongJob ();
			/* TAG END JOB_STATUS_CANCEL EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID TRACE_BUTTON_WINDOW
...
/*
	Handler for window TRACE_BUTTON_WINDOW ("Trace Button")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
TRACE_BUTTON_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
TRACE_BUTTON_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case TRACE_BUTTON: /* "Trace From Image..." */
			{
			/* TAG BEGIN TRACE_BUTTON EVNT:Control */
			         {
			            static FILE_SPEC fs;
#if (XVTWS == MACWS)
			            strcpy (fs.type, "PICT");
			...
			/* TAG END TRACE_BUTTON EVNT:Control */
			}
			break;
		default:
			break;

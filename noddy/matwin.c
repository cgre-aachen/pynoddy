...
*/
#define WIN_RES_ID MATRIX_WINDOW
...
/*
	Handler for window MATRIX_WINDOW ("Matrix")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
MATRIX_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
MATRIX_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case MATRIX_TOP_LEFT: /* "1.0" */
			{
			/* TAG BEGIN MATRIX_TOP_LEFT EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END MATRIX_TOP_LEFT EVNT:Control */
			}
			break;
		case MATRIX_TOP_CENTER: /* "0.0" */
			{
			/* TAG BEGIN MATRIX_TOP_CENTER EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_TOP_CENTER EVNT:Control */
			}
			break;
		case MATRIX_TOP_RIGHT: /* "0.0" */
			{
			/* TAG BEGIN MATRIX_TOP_RIGHT EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_TOP_RIGHT EVNT:Control */
			}
			break;
		case MATRIX_CENTER_LEFT: /* "0.0" */
			{
			/* TAG BEGIN MATRIX_CENTER_LEFT EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_CENTER_LEFT EVNT:Control */
			}
			break;
		case MATRIX_CENTER_CENTER: /* "1.0" */
			{
			/* TAG BEGIN MATRIX_CENTER_CENTER EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_CENTER_CENTER EVNT:Control */
			}
			break;
		case MATRIX_CENTER_RIGHT: /* "0.0" */
			{
			/* TAG BEGIN MATRIX_CENTER_RIGHT EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_CENTER_RIGHT EVNT:Control */
			}
			break;
		case MATRIX_BOTTOM_LEFT: /* "0.0" */
			{
			/* TAG BEGIN MATRIX_BOTTOM_LEFT EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_BOTTOM_LEFT EVNT:Control */
			}
			break;
		case MATRIX_BOTTOM_CENTER: /* "0.0" */
			{
			/* TAG BEGIN MATRIX_BOTTOM_CENTER EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_BOTTOM_CENTER EVNT:Control */
			}
			break;
		case MATRIX_BOTTOM_RIGHT: /* "1.0" */
			{
			/* TAG BEGIN MATRIX_BOTTOM_RIGHT EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MATRIX_BOTTOM_RIGHT EVNT:Control */
			}
			break;
		default:
			break;

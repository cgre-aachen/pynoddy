...
*/
#define WIN_RES_ID SURFACE_SELECTION_WINDOW
...
/*
	Handler for window SURFACE_SELECTION_WINDOW ("Surface Selection")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
SURFACE_SELECTION_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
SURFACE_SELECTION_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case SURFACE_SELECTION_LIST: /* "Layer Selection" */
			{
			/* TAG BEGIN SURFACE_SELECTION_LIST EVNT:Control */
			/* TAG END SURFACE_SELECTION_LIST EVNT:Control */
			}
			break;
		case SURFACE_SELECTION_ALL: /* "All Surfaces" */
			{
			/* TAG BEGIN SURFACE_SELECTION_ALL EVNT:Control */
			int allStrat;
			WINDOW ctl_win = xvt_win_get_ctl(xdWindow, SURFACE_SELECTION_ALL);
			allStrat = !xvt_ctl_is_checked (ctl_win);
			xvt_ctl_set_checked(ctl_win, (BOOLEAN) allStrat);
			updateOptions (xdWindow, VOLUME_SURFACE_OP);
			/* TAG END SURFACE_SELECTION_ALL EVNT:Control */
			}
			break;
		case SURFACE_SELECTION_TYPE: /* "Strat output type" */
			{
			/* TAG BEGIN SURFACE_SELECTION_TYPE EVNT:Control */
			/* TAG END SURFACE_SELECTION_TYPE EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID IPROP_WINDOW
...
/*
	Handler for window IPROP_WINDOW ("Import Props")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
IPROP_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
IPROP_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case IPROP_PROPERTIES: /* "rock prop list but" */
			{
			/* TAG BEGIN IPROP_PROPERTIES EVNT:Control */
			...
			break;
		case IPROP_TRANSPARENT: /* "idx" */
			{
			/* TAG BEGIN IPROP_TRANSPARENT EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END IPROP_TRANSPARENT EVNT:Control */
			}
			break;
		default:
			break;

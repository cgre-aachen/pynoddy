...
/*
	Handler for window AXIS_WINDOW ("Scale (Axis)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
AXIS_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
AXIS_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, AXIS_X_BAR, 0, 20000);
		setScrollRange (xdWindow, AXIS_Y_BAR, 0, 20000);
		setScrollRange (xdWindow, AXIS_Z_BAR, 0, 20000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case AXIS_X_BAR: /* "Horizontal Scrollbar E-X" */
			{
			/* TAG BEGIN AXIS_X_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, AXIS_X, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END AXIS_X_BAR EVNT:Control */
			}
			break;
		case AXIS_Y_BAR: /* "Horizontal Scrollbar E-Y" */
			{
			/* TAG BEGIN AXIS_Y_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, AXIS_Y, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END AXIS_Y_BAR EVNT:Control */
			}
			break;
		case AXIS_Z_BAR: /* "Horizontal Scrollbar E-Z" */
			{
			/* TAG BEGIN AXIS_Z_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, AXIS_Z, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END AXIS_Z_BAR EVNT:Control */
			}
			break;
		case AXIS_X: /* "xaxis" */
			{
			/* TAG BEGIN AXIS_X EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, AXIS_X_BAR,
			                                                      AXIS_X, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END AXIS_X EVNT:Control */
			}
			break;
		case AXIS_Z: /* "zaxis" */
			{
			/* TAG BEGIN AXIS_Z EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, AXIS_Z_BAR,
			                                                      AXIS_Z, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END AXIS_Z EVNT:Control */
			}
			break;
		case AXIS_Y: /* "yaxis" */
			{
			/* TAG BEGIN AXIS_Y EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, AXIS_Y_BAR,
			                                                      AXIS_Y, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END AXIS_Y EVNT:Control */
			}
			break;
		default:
			break;

...
/*
	Handler for window TGMA_WINDOW ("Form (Type, Geom, Movement, Alt)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
TGMA_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
TGMA_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case TGMA_GEOMETRY: /* "Fault Geometry" */
			{
			/* TAG BEGIN TGMA_GEOMETRY EVNT:Control */
			...
			updateShearOptions (data);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END TGMA_GEOMETRY EVNT:Control */
			}
			break;
		case TGMA_MOVEMENT: /* "movement" */
			{
			/* TAG BEGIN TGMA_MOVEMENT EVNT:Control */
			updateFaultOptions ((OBJECT *) xvt_vobj_get_data (xdWindow));
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END TGMA_MOVEMENT EVNT:Control */
			}
			break;
		case TGMA_ALTERATION: /* "Alteration" */
			{
			/* TAG BEGIN TGMA_ALTERATION EVNT:Control */
			updateShearOptions ((OBJECT *) xvt_vobj_get_data (xdWindow));
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END TGMA_ALTERATION EVNT:Control */
			}
			break;
		case TGMA_ALTERATION_EDIT: /* "Edit..." */
			{
		...
		case TGMA_TYPE: /* "type" */
			{
			/* TAG BEGIN TGMA_TYPE EVNT:Control */
			updateShearOptions ((OBJECT *) xvt_vobj_get_data (xdWindow));
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END TGMA_TYPE EVNT:Control */
			}
			break;
		case TGMA_PROFILE_BUTTON: /* "Show Profile..." */
			{
			/* TAG BEGIN TGMA_PROFILE_BUTTON EVNT:Control */
			extern long profileEventHandler ();
			char option[100];
			WINDOW win;
			OBJECT *data = (OBJECT *) xvt_vobj_get_data (xdWindow);

...
/*
	Handler for window GMA_WINDOW ("Form (geom,Move,Alt)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
GMA_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
GMA_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case GMA_GEOMETRY: /* "Fault Geometry" */
			{
			/* TAG BEGIN GMA_GEOMETRY EVNT:Control */
			...
			updateFaultOptions (data);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END GMA_GEOMETRY EVNT:Control */
			}
			break;
		case GMA_MOVEMENT: /* "movement" */
			{
			/* TAG BEGIN GMA_MOVEMENT EVNT:Control */
			updateFaultOptions ((OBJECT *) xvt_vobj_get_data (xdWindow));
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END GMA_MOVEMENT EVNT:Control */
			}
			break;
		case GMA_ALTERATION: /* "List Button 118" */
			{
			/* TAG BEGIN GMA_ALTERATION EVNT:Control */
			updateFaultOptions ((OBJECT *) xvt_vobj_get_data (xdWindow));
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END GMA_ALTERATION EVNT:Control */
			}
			break;
		case GMA_ALTERATION_EDIT: /* "Edit..." */
			{
			...
			break;
		case GMA_COLOR_BUTTON: /* "Define Colour..." */
			{
			...
			break;
		case GMA_PROFILE_BUTTON: /* "Show Profile..." */
			{
			/* TAG BEGIN GMA_PROFILE_BUTTON EVNT:Control */
			extern long profileEventHandler ();
			char option[100];
			WINDOW win;
			OBJECT *data = (OBJECT *) xvt_vobj_get_data (xdWindow);

...
*/
#define WIN_RES_ID DEFORM_FIELD_WINDOW
...
/*
	Handler for window DEFORM_FIELD_WINDOW ("Deform Fields")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
DEFORM_FIELD_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
DEFORM_FIELD_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case DEFORM_FIELD_REMANENCE: /* "Remanence" */
			{
			/* TAG BEGIN DEFORM_FIELD_REMANENCE EVNT:Control */
			WINDOW ctl_win = xvt_win_get_ctl(xdWindow, DEFORM_FIELD_REMANENCE);
			xvt_ctl_set_checked(ctl_win, (BOOLEAN) (!xvt_ctl_is_checked(ctl_win)));
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END DEFORM_FIELD_REMANENCE EVNT:Control */
			}
			break;
		case DEFORM_FIELD_ANISOTROPY: /* "Anisotropy" */
			{
			/* TAG BEGIN DEFORM_FIELD_ANISOTROPY EVNT:Control */
			WINDOW ctl_win = xvt_win_get_ctl(xdWindow, DEFORM_FIELD_ANISOTROPY);
			xvt_ctl_set_checked(ctl_win, (BOOLEAN) (!xvt_ctl_is_checked(ctl_win)));
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END DEFORM_FIELD_ANISOTROPY EVNT:Control */
			}
			break;
		default:
			break;

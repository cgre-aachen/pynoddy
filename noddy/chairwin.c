...
*/
#define WIN_RES_ID CHAIR_WINDOW
...
/*
	Handler for window CHAIR_WINDOW ("Chair window")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
CHAIR_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
CHAIR_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, CHAIR_X_BAR, -10000, 10000);
		setScrollRange (xdWindow, CHAIR_Y_BAR, -10000, 10000);
		setScrollRange (xdWindow, CHAIR_Z_BAR, -10000, 10000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case CHAIR_X_BAR: /* "Horizontal Scrollbar CX" */
			{
			/* TAG BEGIN CHAIR_X_BAR EVNT:Control */
			         int pos = 0;
			         /*
			         ...
			         */
			         ...
			         updateNumericTextField (xdWindow, CHAIR_X, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END CHAIR_X_BAR EVNT:Control */
			}
			break;
		case CHAIR_Y_BAR: /* "Horizontal Scrollbar CY" */
			{
			/* TAG BEGIN CHAIR_Y_BAR EVNT:Control */
			         int pos = 0;
			         /*
			            Horizontal scrollbar control was operated
			         */
			         ...
			         pos = updateScrollField (xdWindow, xdControlId, pos);
			         updateNumericTextField (xdWindow, CHAIR_Y, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END CHAIR_Y_BAR EVNT:Control */
			}
			break;
		case CHAIR_Z_BAR: /* "Horizontal Scrollbar CZ" */
			{
			/* TAG BEGIN CHAIR_Z_BAR EVNT:Control */
			         int pos = 0;
			         /*
			            Horizontal scrollbar control was operated
			         */
			         ...
			         pos = updateScrollField (xdWindow, xdControlId, pos);
			         updateNumericTextField (xdWindow, CHAIR_Z, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END CHAIR_Z_BAR EVNT:Control */
			}
			break;
		case CHAIR_X: /* "x" */
			{
			/* TAG BEGIN CHAIR_X EVNT:Control */
			         /*
			         ...
			         */
			         if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			            ...
			            */
			         updateScrollAndText (xdWindow, CHAIR_X_BAR, CHAIR_X, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			         }
			/* TAG END CHAIR_X EVNT:Control */
			}
			break;
		case CHAIR_Z: /* "z" */
			{
			/* TAG BEGIN CHAIR_Z EVNT:Control */
			         /*
			            Edit control was operated.
			         */
			         if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			            ...
			            /*
			               Contents of control were changed
			            */
			         updateScrollAndText (xdWindow, CHAIR_Z_BAR, CHAIR_Z, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			         }
			/* TAG END CHAIR_Z EVNT:Control */
			}
			break;
		case CHAIR_Y: /* "y" */
			{
			/* TAG BEGIN CHAIR_Y EVNT:Control */
			         /*
			            Edit control was operated.
			         */
			         if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			            ...
			            /*
			               Contents of control were changed
			            */
			         updateScrollAndText (xdWindow, CHAIR_Y_BAR, CHAIR_Y, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			         }
			/* TAG END CHAIR_Y EVNT:Control */
			}
			break;
		case CHAIR_USE: /* " Use Chair Diagram" */
			{
			/* TAG BEGIN CHAIR_USE EVNT:Control */
			         WINDOW ctl_win = xvt_win_get_ctl(xdWindow, CHAIR_USE);
			         int state = (!xvt_ctl_is_checked(ctl_win));
			         xvt_ctl_set_checked(ctl_win, (BOOLEAN) state);
			                  /* enable the options that should be alloud */
			         updateOptions (xdWindow, GEOLOGY_DISPLAY_OP);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END CHAIR_USE EVNT:Control */
			}
			break;
		default:
			break;

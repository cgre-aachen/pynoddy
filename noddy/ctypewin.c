...
*/
#define WIN_RES_ID CALC_TYPE_WINDOW
...
/*
	Handler for window CALC_TYPE_WINDOW ("Calc Type")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
CALC_TYPE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
CALC_TYPE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case CALC_TYPE_LIST: /* "Calc type list" */
			{
			/* TAG BEGIN CALC_TYPE_LIST EVNT:Control */
			updateOptions (xdWindow, GEOPHYSICS_CALC_OP);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END CALC_TYPE_LIST EVNT:Control */
			}
			break;
		case CALC_TYPE_PROJECT_FIELDS: /* "Project Fields" */
			{
			/* TAG BEGIN CALC_TYPE_PROJECT_FIELDS EVNT:Control */
			WINDOW ctl_win = xvt_win_get_ctl(xdWindow, CALC_TYPE_PROJECT_FIELDS);
			xvt_ctl_set_checked(ctl_win, !xvt_ctl_is_checked(ctl_win));
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END CALC_TYPE_PROJECT_FIELDS EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID USE_TOPOGRAPHY_WINDOW
...
/*
	Handler for window USE_TOPOGRAPHY_WINDOW ("Use Topography")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
USE_TOPOGRAPHY_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
USE_TOPOGRAPHY_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case USE_TOPOGRAPHY: /* "Use Topography" */
			{
			/* TAG BEGIN USE_TOPOGRAPHY EVNT:Control */
			         int gotTopo = FALSE;
			         OBJECT *data = (OBJECT *) xvt_vobj_get_data (xdWindow);
			         WINDOW win;
			         WINDOW ctl_win = xvt_win_get_ctl(xdWindow, USE_TOPOGRAPHY);
			         int checked;
			...
			/* TAG END USE_TOPOGRAPHY EVNT:Control */
			}
			break;
		default:
			break;

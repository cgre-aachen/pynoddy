...
*/
#define WIN_RES_ID PADDING_WINDOW
...
/*
	Handler for window PADDING_WINDOW ("Spectral Padding")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
PADDING_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
PADDING_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case PADDING_TYPE: /* "pad type" */
			{
			/* TAG BEGIN PADDING_TYPE EVNT:Control */
			updateOptions (xdWindow, GEOPHYSICS_CALC_OP);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END PADDING_TYPE EVNT:Control */
			}
			break;
		case PADDING_SUSX: /* "pad sus x" */
			{
			/* TAG BEGIN PADDING_SUSX EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END PADDING_SUSX EVNT:Control */
			}
			break;
		case PADDING_SUSY: /* "pad sus y" */
			{
			/* TAG BEGIN PADDING_SUSY EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END PADDING_SUSY EVNT:Control */
			}
			break;
		case PADDING_SUSZ: /* "pad sus z" */
			{
			/* TAG BEGIN PADDING_SUSZ EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END PADDING_SUSZ EVNT:Control */
			}
			break;
		case PADDING_DENSITY: /* "pad density" */
			{
			/* TAG BEGIN PADDING_DENSITY EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END PADDING_DENSITY EVNT:Control */
			}
			break;
		case PADDING_FENCE: /* "pad fence" */
			{
			/* TAG BEGIN PADDING_FENCE EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END PADDING_FENCE EVNT:Control */
			}
			break;
		case PADDING_PERCENT: /* "pad percent" */
			{
			/* TAG BEGIN PADDING_PERCENT EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END PADDING_PERCENT EVNT:Control */
			}
			break;
		default:
			break;

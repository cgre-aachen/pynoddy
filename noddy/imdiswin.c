...
*/
#define WIN_RES_ID GEOPHYSICS_IDISPLAY_WINDOW
...
/*
	Handler for window GEOPHYSICS_IDISPLAY_WINDOW ("Geoph Image Display")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
GEOPHYSICS_IDISPLAY_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
GEOPHYSICS_IDISPLAY_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case GEOPHYSICS_GRAVITY_IDISPLAY: /* "Gravity Display..." */
			{
			/* TAG BEGIN GEOPHYSICS_GRAVITY_IDISPLAY EVNT:Control */
			...
			break;
		case GEOPHYSICS_MAGNETICS_IDISPLAY: /* "Magnetic Display..." */
			{
			/* TAG BEGIN GEOPHYSICS_MAGNETICS_IDISPLAY EVNT:Control */
			extern PROJECT_OPTIONS projectOptions;
			extern WINDOW lastActiveWindow;
			OBJECT *data = (OBJECT *) xvt_vobj_get_data (xdWindow);
			WINDOW win;

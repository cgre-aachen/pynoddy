...
/*
	Handler for window FSCL_WINDOW ("Scale (fault)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
FSCL_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
FSCL_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, FSCL_ROTATION_BAR, 0, 360);
		setScrollRange (xdWindow, FSCL_SLIP_BAR, -10000, 10000);
		setScrollRange (xdWindow, FSCL_AMPLITUDE_BAR, 0, 20000);
		setScrollRange (xdWindow, FSCL_RADIUS_BAR, 0, 20000);
		setScrollRange (xdWindow, FSCL_CYL_BAR, 0, 20000);
		setScrollRange (xdWindow, FSCL_PP_BAR, 0, 360);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case FSCL_SLIP_BAR: /* "Horizontal Scrollbar Slip" */
			{
			/* TAG BEGIN FSCL_SLIP_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, FSCL_SLIP, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FSCL_SLIP_BAR EVNT:Control */
			}
			break;
		case FSCL_SLIP: /* "slip" */
			{
			/* TAG BEGIN FSCL_SLIP EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, FSCL_SLIP_BAR,
			                                                      FSCL_SLIP, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FSCL_SLIP EVNT:Control */
			}
			break;
		case FSCL_ROTATION_BAR: /* "Horizontal Scrollbar Rotation" */
			{
			/* TAG BEGIN FSCL_ROTATION_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FSCL_ROTATION, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FSCL_ROTATION_BAR EVNT:Control */
			}
			break;
		case FSCL_ROTATION: /* "30" */
			{
			/* TAG BEGIN FSCL_ROTATION EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FSCL_ROTATION_BAR,
			                                                      FSCL_ROTATION, TRUE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FSCL_ROTATION EVNT:Control */
			}
			break;
		case FSCL_AMPLITUDE_BAR: /* "amplitude bar" */
			{
			/* TAG BEGIN FSCL_AMPLITUDE_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FSCL_AMPLITUDE, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FSCL_AMPLITUDE_BAR EVNT:Control */
			}
			break;
		case FSCL_AMPLITUDE: /* "amplitude" */
			{
			/* TAG BEGIN FSCL_AMPLITUDE EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FSCL_AMPLITUDE_BAR,
			                                                      FSCL_AMPLITUDE, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FSCL_AMPLITUDE EVNT:Control */
			}
			break;
		case FSCL_RADIUS_BAR: /* "Horizontal Scrollbar RADIUS" */
			{
			/* TAG BEGIN FSCL_RADIUS_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FSCL_RADIUS, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FSCL_RADIUS_BAR EVNT:Control */
			}
			break;
		case FSCL_RADIUS: /* "radius" */
			{
			/* TAG BEGIN FSCL_RADIUS EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FSCL_RADIUS_BAR,
			                                                      FSCL_RADIUS, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			
			}
			/* TAG END FSCL_RADIUS EVNT:Control */
			}
			break;
		case FSCL_CYL_BAR: /* "Horizontal Scrollbar CI" */
			{
			/* TAG BEGIN FSCL_CYL_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FSCL_CYL, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FSCL_CYL_BAR EVNT:Control */
			}
			break;
		case FSCL_CYL: /* "CI" */
			{
			/* TAG BEGIN FSCL_CYL EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FSCL_CYL_BAR,
			                                                      FSCL_CYL, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FSCL_CYL EVNT:Control */
			}
			break;
		case FSCL_PP_BAR: /* "Horizontal Scrollbar PP" */
			{
			/* TAG BEGIN FSCL_PP_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			pos = updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, FSCL_PP, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END FSCL_PP_BAR EVNT:Control */
			}
			break;
		case FSCL_PP: /* "PP" */
			{
			/* TAG BEGIN FSCL_PP EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, FSCL_PP_BAR,
			                                                      FSCL_PP, FALSE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END FSCL_PP EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID ASSIGN_PROP_WINDOW
...
/*
	Handler for window ASSIGN_PROP_WINDOW ("Assign Properties")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
ASSIGN_PROP_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
ASSIGN_PROP_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case ASSIGN_PROP_LIST: /* "Layer list" */
			{
			/* TAG BEGIN ASSIGN_PROP_LIST EVNT:Control */
			/* TAG END ASSIGN_PROP_LIST EVNT:Control */
			}
			break;
		case ASSIGN_PROP_EDIT: /* "Edit..." */
			{
			/* TAG BEGIN ASSIGN_PROP_EDIT EVNT:Control */
			/* TAG END ASSIGN_PROP_EDIT EVNT:Control */
			}
			break;
		case ASSIGN_PROP_OK: /* "OK" */
			{
			/* TAG BEGIN ASSIGN_PROP_OK EVNT:Control */
						/* ********************************** */
						/* save all the options in the window */
			xvt_vobj_destroy(xdWindow);
			/* TAG END ASSIGN_PROP_OK EVNT:Control */
			}
			break;
		case ASSIGN_PROP_CANCEL: /* "Cancel" */
			{
			/* TAG BEGIN ASSIGN_PROP_CANCEL EVNT:Control */
				/* ******************************************************* */
				/* restore the options that were saved when first poped up */
			xvt_vobj_destroy(xdWindow);
			/* TAG END ASSIGN_PROP_CANCEL EVNT:Control */
			}
			break;
		case ASSIGN_PROP_HELP: /* "Help..." */
			{
			/* TAG BEGIN ASSIGN_PROP_HELP EVNT:Control */
			displayHelp("BaseEv.htm");
			/* TAG END ASSIGN_PROP_HELP EVNT:Control */
			}
			break;
		default:
			break;

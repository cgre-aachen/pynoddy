...
*/
#define WIN_RES_ID ROTATION_WINDOW
...
/*
	Handler for window ROTATION_WINDOW ("Scale (Rotation)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
ROTATION_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
ROTATION_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, ROTATION_ROT_BAR, 0, 360);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case ROTATION_ROT_BAR: /* "rotation" */
			{
			/* TAG BEGIN ROTATION_ROT_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, ROTATION_ROT, pos);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			/* TAG END ROTATION_ROT_BAR EVNT:Control */
			}
			break;
		case ROTATION_ROT: /* "rot" */
			{
			/* TAG BEGIN ROTATION_ROT EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, ROTATION_ROT_BAR, ROTATION_ROT, TRUE);
			update3dPreview (xdWindow, (OBJECT *) xvt_vobj_get_data (xdWindow));
			}
			/* TAG END ROTATION_ROT EVNT:Control */
			}
			break;
		default:
			break;

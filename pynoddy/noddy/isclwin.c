...
/*
	Handler for window ISCL_WINDOW ("Import (Block Size)")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
ISCL_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
ISCL_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, ISCL_BSIZE_BAR, 0, 20000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case ISCL_BSIZE: /* "scale" */
			{
			/* TAG BEGIN ISCL_BSIZE EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, ISCL_BSIZE_BAR, ISCL_BSIZE, FALSE);
			}
			/* TAG END ISCL_BSIZE EVNT:Control */
			}
			break;
		case ISCL_BSIZE_BAR: /* "block size scrollbar" */
			{
			/* TAG BEGIN ISCL_BSIZE_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, ISCL_BSIZE, pos);
			/* TAG END ISCL_BSIZE_BAR EVNT:Control */
			}
			break;
		default:
			break;

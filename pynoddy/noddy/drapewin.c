...
*/
#define WIN_RES_ID DRAPED_SURVEY_WINDOW
...
/*
	Handler for window DRAPED_SURVEY_WINDOW ("Draped Survey")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
DRAPED_SURVEY_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
DRAPED_SURVEY_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case DRAPED_SURVEY: /* "Draped Survey" */
			{
			/* TAG BEGIN DRAPED_SURVEY EVNT:Control */
			WINDOW ctl_win = xvt_win_get_ctl(xdWindow, DRAPED_SURVEY);
			xvt_ctl_set_checked(ctl_win, (BOOLEAN) (!xvt_ctl_is_checked(ctl_win)));
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END DRAPED_SURVEY EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID ORIGIN_WINDOW
...
/*
	Handler for window ORIGIN_WINDOW ("View Origin")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
ORIGIN_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
ORIGIN_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, ORIGIN_X_BAR, -10000, 10000);
		setScrollRange (xdWindow, ORIGIN_Y_BAR, -10000, 10000);
		setScrollRange (xdWindow, ORIGIN_Z_BAR, -10000, 10000);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case ORIGIN_X_BAR: /* "Horizontal Scrollbar OX" */
			{
			/* TAG BEGIN ORIGIN_X_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, ORIGIN_X, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END ORIGIN_X_BAR EVNT:Control */
			}
			break;
		case ORIGIN_Y_BAR: /* "Horizontal Scrollbar OY" */
			{
			/* TAG BEGIN ORIGIN_Y_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, ORIGIN_Y, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END ORIGIN_Y_BAR EVNT:Control */
			}
			break;
		case ORIGIN_Z_BAR: /* "Horizontal Scrollbar OZ" */
			{
			/* TAG BEGIN ORIGIN_Z_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, ORIGIN_Z, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END ORIGIN_Z_BAR EVNT:Control */
			}
			break;
		case ORIGIN_X: /* "x" */
			{
			/* TAG BEGIN ORIGIN_X EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, ORIGIN_X_BAR, ORIGIN_X, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END ORIGIN_X EVNT:Control */
			}
			break;
		case ORIGIN_Z: /* "z" */
			{
			/* TAG BEGIN ORIGIN_Z EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, ORIGIN_Z_BAR, ORIGIN_Z, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END ORIGIN_Z EVNT:Control */
			}
			break;
		case ORIGIN_Y: /* "y" */
			{
			/* TAG BEGIN ORIGIN_Y EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, ORIGIN_Y_BAR, ORIGIN_Y, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END ORIGIN_Y EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID CUBE_SIZE_WINDOW
...
/*
	Handler for window CUBE_SIZE_WINDOW ("Cube Size")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
CUBE_SIZE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
CUBE_SIZE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case CUBE_SIZE_GEOLOGY: /* "geology Cube" */
			{
			/* TAG BEGIN CUBE_SIZE_GEOLOGY EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END CUBE_SIZE_GEOLOGY EVNT:Control */
			}
			break;
		case CUBE_SIZE_GEOPHYSICS: /* "geophysics cube" */
			{
			/* TAG BEGIN CUBE_SIZE_GEOPHYSICS EVNT:Control */
			/*
				Listedit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END CUBE_SIZE_GEOPHYSICS EVNT:Control */
			}
			break;
		default:
			break;

...
*/
#define WIN_RES_ID MOVIE_WINDOW
...
/*
	Handler for window MOVIE_WINDOW ("Movie")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
MOVIE_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
MOVIE_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, MOVIE_REPLAY_SPEED_BAR, 0, 30);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case MOVIE_GENERATION_FRAMES: /* "frames" */
			{
			/* TAG BEGIN MOVIE_GENERATION_FRAMES EVNT:Control */
			/*
			...
			*/
			...
			/* TAG END MOVIE_GENERATION_FRAMES EVNT:Control */
			}
			break;
		case MOVIE_REPLAY_SPEED_BAR: /* "Horizontal Scrollbar 4" */
			{
			/* TAG BEGIN MOVIE_REPLAY_SPEED_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			/* TAG END MOVIE_REPLAY_SPEED_BAR EVNT:Control */
			}
			break;
		case MOVIE_REPLAY_SPEED: /* "speed" */
			{
			/* TAG BEGIN MOVIE_REPLAY_SPEED EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
			...
			/* TAG END MOVIE_REPLAY_SPEED EVNT:Control */
			}
			break;
		case MOVIE_GENERATION_TYPE: /* "movietype" */
			{
			/* TAG BEGIN MOVIE_GENERATION_TYPE EVNT:Control */
			/* TAG END MOVIE_GENERATION_TYPE EVNT:Control */
			}
			break;
		default:
			break;

...
/*
	Handler for window UNIT_WINDOW ("Unit m/feet")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
UNIT_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
UNIT_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case UNIT_METERS: /* "Metres" */
			{
			/* TAG BEGIN UNIT_METERS EVNT:Control */
			xdCheckRadioButton(xdWindow,
				UNIT_METERS,
				UNIT_METERS,
				UNIT_FEET);
			/* TAG END UNIT_METERS EVNT:Control */
			}
			break;
		case UNIT_FEET: /* "Feet" */
			{
			/* TAG BEGIN UNIT_FEET EVNT:Control */
			xdCheckRadioButton(xdWindow,
				UNIT_FEET,
				UNIT_METERS,
				UNIT_FEET);
			/* TAG END UNIT_FEET EVNT:Control */
			}
			break;
		default:
			break;

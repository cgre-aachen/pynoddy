...
*/
#define WIN_RES_ID THREED_VIEW_WINDOW
...
/*
	Handler for window THREED_VIEW_WINDOW ("threed view")
*/
long XVT_CALLCONV1
#if XVT_CC_PROTO
THREED_VIEW_WINDOW_eh XVT_CALLCONV2 (WINDOW xdWindow, EVENT *xdEvent)
#else
THREED_VIEW_WINDOW_eh XVT_CALLCONV2 (xdWindow, xdEvent)
WINDOW xdWindow;
EVENT *xdEvent;
#endif
{
	...
	case E_CREATE:
		...
		*/
		...
		setScrollRange (xdWindow, THREED_DECL_BAR, 0, 360);
		setScrollRange (xdWindow, THREED_AZIMUTH_BAR, 0, 90);
		setScrollRange (xdWindow, THREED_SCALE_BAR, 1, 200);
		/* TAG END EVNT:Create */
		}
		break;
	case E_DESTROY:
	...
	case E_CONTROL:
		...
		*/
		...
		switch(xdControlId) {
		case THREED_DECL_BAR: /* "Horizontal Scrollbar Decl" */
			{
			/* TAG BEGIN THREED_DECL_BAR EVNT:Control */
			int pos = 0;
			/*
			...
			*/
			...
			updateNumericTextField (xdWindow, THREED_DECL, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END THREED_DECL_BAR EVNT:Control */
			}
			break;
		case THREED_AZIMUTH_BAR: /* "Horizontal Scrollbar Azimuth" */
			{
			/* TAG BEGIN THREED_AZIMUTH_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			updateScrollField (xdWindow, xdControlId, pos);
			updateNumericTextField (xdWindow, THREED_AZIMUTH, pos);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END THREED_AZIMUTH_BAR EVNT:Control */
			}
			break;
		case THREED_SCALE_BAR: /* "Horizontal Scrollbar RZ" */
			{
			/* TAG BEGIN THREED_SCALE_BAR EVNT:Control */
			int pos = 0;
			/*
				Horizontal scrollbar control was operated
			*/
			...
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			/* TAG END THREED_SCALE_BAR EVNT:Control */
			}
			break;
		case THREED_DECL: /* "decl" */
			{
			/* TAG BEGIN THREED_DECL EVNT:Control */
			/*
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				*/
			updateScrollAndText (xdWindow, THREED_DECL_BAR, THREED_DECL, TRUE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END THREED_DECL EVNT:Control */
			}
			break;
		case THREED_AZIMUTH: /* "azimuth" */
			{
			/* TAG BEGIN THREED_AZIMUTH EVNT:Control */
			/*
				Edit control was operated.
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, THREED_AZIMUTH_BAR, THREED_AZIMUTH, TRUE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
			/* TAG END THREED_AZIMUTH EVNT:Control */
			}
			break;
		case THREED_SCALE: /* "scale" */
			{
			...
			*/
			if (xdEvent->v.ctl.ci.v.edit.focus_change) {
				...
				/*
					Contents of control were changed
				*/
			updateScrollAndText (xdWindow, THREED_SCALE_BAR, THREED_SCALE, FALSE);
			update3dPreview (NULL_WIN, (OBJECT *) NULL);
			}
